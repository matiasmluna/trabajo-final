                            ...
                            <div class="widget-box">
                                ...
                                <div class="widget-content nopadding">
                                    <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/add-product') }}" name="add_product" id="add_product">{{ csrf_field() }}
                                        ...
                                        <p>Nombre: <br><input id="product_name" title="Debe tener mas de 3 letras" type="text" name="product_name" required pattern="[A-Z]).{3,}"></p>
                                        <p>Codigo: <br><input id="product_code" title="Deben ser numeros" type="text" name="product_code" required pattern="[0-9]{3,10}"></p>
                                        <p>Color: <br><input id="product_color" title="Debe ser un color" type="text" name="product_color" required pattern="[A-z]).{3,20}"></p>
                                        <p>Price: <br><input id="price" title="Debe ser numero" type="text" name="price" required pattern="[0-9]{1,20}"></p>
