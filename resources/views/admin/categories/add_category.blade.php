    ...
    <div id="main-wrapper">
        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <form id="myForm" method="POST" action="{{ url('/admin/add-category') }}"> {{ csrf_field() }}
<p>Nombre: <input id="category_name" title="Debe tener mas de 3 letras" type="text" name="category_name" required pattern="[A-Z]).{3,}"></p>
<p>Descripcion: <textarea id="description" title="Debes incluir una descripcion" type="text" required pattern="[A-Z]).{1,}" name="description" cols="30"></textarea></p>
<p>Slug: <input id="slug" title="Ingresa la misma Contraseña." type="text" required pattern="[A-Z]).{1,}" name="slug"></p>
<p><input type="submit" value="Agregar categoria" class="btn btn-success"></p>
</form>
            </div>
