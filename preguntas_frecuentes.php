    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
          <input class="form-control mr-sm-2" type="search" placeholder="Busca tus zapatillas y más... " aria-label="...">
 ...
 -->
    <section>
      ...
      <h1 style="font-size: 36px">Preguntas frecuentes</h1>
        ...
        <h2 class="text-body" style="font-size: 18px"></h2>
    </section>
    		...
    		<section class="footer-top padding-top">
    			<div class="row">
    				<aside class="col-sm-3 col-md-3 white">
    				 <h5 class="title">Atención al cliente</h5>
                  ...
                  <br>
                  <strong>Mail:</strong> info@sportlife.com.ar
    						</p>
