                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="gradeX">
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <img src="{{ asset('/images/backend_img/product/small/'.$product->image) }}" style="width:50px;">
                                                                @endif
                                                            </td>
                                                            <td class="center">
                                                                <a href="{{ url('/admin/edit-product/'.$product->id) }}" class="btn btn-primary btn-mini">Editar</a>
                                                                <a id="delProduct" rel="{{ $product->id }}" rel1="delete-product" href="{{ url('/admin/delete-product/'.$product->id) }}" class="btn btn-danger btn-mini deleteRecord" id="delProduct" onclick="return confirm('Estas seguro que deseas eliminarlo?')">Borrar</a>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                    <tfoot>
