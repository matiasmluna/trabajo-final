...
class ProductsController extends Controller
{
    ...
    public function mostrar(Request $req, $categorySlug, $productSlug) {
    ...
    public function editProduct(Request $request, $id = null)
     {
        if ($request->isMethod('post')) {
            ...
            Product::where(['id' => $id])->update([
                'status' => $status, 'category_id' => $data['category_id'], 'name' => $data['name'],
                'slug' => $data['slug'], 'product_color' => $data['product_color'], 'description' => $data['description'], 'price' => $data['price'], 'image' => $fileName
            ]);
