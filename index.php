...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="#"><img class="logo" src="images/logos/logo.png" alt="alibaba style e-commerce html template file" title="alibaba e-commerce html css theme"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarTop">
        <ul class="navbar-nav mr-auto">
          ...
          <li><a href="#" class="nav-link " >   Registrate gratis </a>
          <li><a href="#" class="nav-link " >   Tiendas oficiales </a>
    ...
    <div class="col-lg-9-24 col-sm-12">
      <div class="widgets-wrap float-right row no-gutters py-1">
        ...
        <div class="col-auto">
          <a href="#" class="widget-header">
            <div class="icontext">
              <div class="icon-wrap"><i class="text-dark icon-sm  fa fa-heart"></i></div>
              <div class="text-wrap text-dark">
  ...
  <div class="slide mb-3">
    <div class="carousel-inner">
      ...
      <div class="carousel-caption d-none d-md-block sliderContenido">
        ...
        <button type="button" class="btn btn-light comprarBoton">Comprar</button>
        </div>
      </div>
    </div>
    </div>
...
<div class="hideonmobile container mt-25 mb-5">
  ...
  <h4 class="gl-text-center color-theme-black___1htzw">¿QUÉ TIPO DE JUGADOR ERES?</h4></div>
  ...
  <div class="parallax__layer parallax__layer--fg">
    <div class="parallax__layer__cell parallax__layer__cell--fg">
      ...
      <a href="#"><button type="button" class="btn btn-outline-dark botonslide">Comprar</button></a></div>
    <div class="parallax__layer__cell parallax__layer__cell--fg">
        ...
        <div class="card">
          <div class="card-head2">
            ...
            <div class="product-detail">
              <h2>Botines Adidas</h2><p class="fadetext">ADIDAS</p><p class="fadetext">ADIDAS</p><p class="fadetext">ADIDAS</p>
            </div>
