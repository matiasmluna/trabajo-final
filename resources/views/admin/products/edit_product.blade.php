                            ...
                            <div class="widget-box">
                                ...
                                <div class="widget-content nopadding">
                                    <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit-product/'.$productDetails->id) }}" name="edit_product" id="edit_product">{{ csrf_field() }}
                                        ...
                                        <p>Nombre: <br><input id="name" title="Debe tener mas de 3 letras" type="text" name="name" required pattern="[A-Z]).{3,}" value="{{ $productDetails->name }}"></p>
                                        <p>Slug: <br><input id="slug" title="Deben ser letras" type="text" name="slug" required pattern="[A-z]).{3,20}" value="{{ $productDetails->slug }}"></p>
