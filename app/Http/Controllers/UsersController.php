...
class UsersController extends Controller
{
    ...
    public function perfil(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            if(empty($data['name'])){
                return redirect()->back()->with('flash_message_error','Por favor ingrese los nuevos datos');
            }
        ...
        return view('perfil')->with(compact('user_id','userDetails'));
    }
    ...
    public function updatePassword(Request $request){
        if($request->isMethod('post')){
            ...
            if(Hash::check($current_pwd,$old_pwd->password)){
                ...
                return redirect()->back()->with('flash_message_success',' Contraseña actualizaday!');
            }else{
                return redirect()->back()->with('flash_message_error','Contraseña actual incorrecta');
            }
        }
    }
